...
(see [README](https://github.com/antmicro/kenning-pipeline-manager/blob/main/pipeline_manager/frontend_tester/README.md) for build instructions).
You can check a deployed instance in [Frontend-to-Frontend demo](resource:tester_api/index.html).
